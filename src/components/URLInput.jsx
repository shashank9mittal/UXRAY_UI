    ...
    <div className="w-full my-8 block">
      <div className="flex justify-center">
        <form onSubmit={handleSubmit} className="w-full max-w-2xl px-4">
          ...
          {/* Progress Updates */}
          {isLoading && progress && (
            <div className="mt-3 p-3 rounded-lg bg-blue-500/10 border border-blue-500/50 text-blue-400 text-sm">
          ...
          {/* Progress Messages Log */}
          {progressMessages.length > 0 && (
            <div className="mt-3 p-3 rounded-lg bg-slate-800/50 border border-slate-700 text-gray-400 text-sm max-h-48 overflow-y-auto">
              <div className="font-semibold text-white mb-2">Progress Updates:</div>
