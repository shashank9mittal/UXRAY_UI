  ...
  return (
    <div className="w-full my-8 block">
            ...
            <div className="mt-3 p-3 rounded-lg bg-slate-800/50 border border-slate-700">
              ...
              {progressMessages.length > 0 && (
                <div className="flex items-center gap-2 text-blue-400 text-sm">
                  ...
                  <span>{progressMessages[progressMessages.length - 1]}</span>
                </div>
              )}
      ...
      {(executionResults.length > 0 || currentExecution) && (
        <div className="mt-6">
          <ExecutionTimeline executionResults={executionResults} currentExecution={currentExecution} />
        </div>
      )}
